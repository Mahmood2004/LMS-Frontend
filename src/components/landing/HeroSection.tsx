      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold font-display leading-tight tracking-tight text-foreground">
            ...
            <span className="text-gradient">Progress Deeper.</span>
          </h1>

          <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            A modern AI-powered Learning Management System designed to enhance
            student growth, empower instructors with rich qualitative feedback,
            and transform coursework into meaningful progress.
          </p>
        ...
        >
          {[
            ...
            { value: "500+", label: "AI-Assisted Courses" },
